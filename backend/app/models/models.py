...
class UsuarioModel:
            ...
            with conn.cursor() as cursor:
                cursor.execute("""
                    INSERT INTO cuentas(
                        ...
                        telefono, codigo_estudiante, rol
                    )
            ...
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT id, nombre, apellido, correo,
                           telefono, codigo_estudiante, rol, foto_perfil
                    FROM cuentas
                    WHERE id = %s
                """, (usuario_id,))
                return cursor.fetchone()
    ...
    def cambiar_contrasena(
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT contrasena FROM cuentas WHERE id = %s
                """, (usuario_id,))
                resultado = cursor.fetchone()
                ...
                cursor.execute("""
                    UPDATE cuentas SET contrasena = %s WHERE id = %s
    ...
    def obtener_alumnos_con_estado():
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT
                        u.id, u.nombre, u.apellido, u.codigo_estudiante,
                        u.telefono, u.correo, u.foto_perfil,
...
class ObjetoModel:
    ...
    def obtener_todos():
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT o.id, o.nombre, o.qr_code, o.descripcion,
                           c.nombre as categoria, u.nombre as dueno
                    FROM objetos o
    ...
    def obtener_por_qr(qr_code: str):
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT o.id, o.nombre, o.qr_code, o.descripcion,
                           c.nombre as categoria, u.nombre as dueno, o.usuario_id
                    FROM objetos o
                    JOIN categorias c ON o.categoria_id = c.id
                    JOIN cuentas u ON o.usuario_id = u.id
                    WHERE o.qr_code = %s
    ...
    def obtener_por_id(objeto_id: int):
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT o.id, o.nombre, o.qr_code, o.descripcion,
                           c.nombre as categoria, u.nombre as dueno, o.fecha_creacion
                    FROM objetos o
                    JOIN categorias c ON o.categoria_id = c.id
                    JOIN cuentas u ON o.usuario_id = u.id
                    WHERE o.id = %s
    ...
    def obtener_objetos_usuario(usuario_id: int):
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT o.id, o.nombre, o.qr_code, o.descripcion,
                           c.nombre as categoria, o.fecha_creacion, o.usuario_id
                    FROM objetos o
...
class EscaneoModel:
    ...
    def registrar_escaneo(
        ...
        try:
            with conn.cursor() as cursor:
                ...
                tipo_evento = 'ENTRADA' if (ultimo is None or ultimo["tipo_evento"] == 'SALIDA') else 'SALIDA'
    ...
    def obtener_historial(limite: int = 100):
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT e.id, o.nombre, o.qr_code, e.ubicacion, e.dispositivo,
                           e.fecha_hora, u.nombre as alumno, u.apellido,
                           u.codigo_estudiante, u.telefono, e.tipo_evento
                    FROM escaneos e
                    JOIN objetos o ON e.objeto_id = o.id
    ...
    def obtener_historial_usuario(usuario_id: int, limite: int = 100):
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("""
                    SELECT e.id, o.id as objeto_id, o.nombre, o.qr_code,
                           e.ubicacion, e.dispositivo, e.fecha_hora
                    FROM escaneos e
                    JOIN objetos o ON e.objeto_id = o.id
                    WHERE e.usuario_id = %s
                    ORDER BY e.fecha_hora DESC
